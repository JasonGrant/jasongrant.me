        ...
        <Section py="4">
            <Flex direction="column" gap="5">
                <Flex direction="column" gap="1">
                    ...
                    <Text as="p" size="3">
                        Jason has played a pivotal role in driving <InlineLink label="Klaviyo's" url="/klaviyo" /> 8x revenue growth and its 
                        ...
                        to <InlineLink label="International" url="/klaviyo/work/internationalization" /> expansion, core business initiatives to drive 
                        adoption and growth, and serving as the design representative at PRD reviews. Jason established the design system 
                        and content design functions, leading the creation and implementation of the <InlineLink label="Ascent Design System" url="/klaviyo/work/ascentdesignsystem" />
                ...
                <Flex direction="column" gap="1">
                    ...
                    <Text as="p" size="3">
                        Before Klaviyo, Jason established the design team at <InlineLink label="Vertex Pharmaceuticals" url="/vertex" />,
                        where he created the <InlineLink label="VIA Design System" url="/vertex/work/via" /> (Web components). This system 
                        ...
                        <InlineLink label="Lab of Our Future" url="/vertex/work/loof" /> initiative and the 
                        <InlineLink label="Vertex Informatics Platform" url="/vertex/work/vip" />, both of which utilized the 
