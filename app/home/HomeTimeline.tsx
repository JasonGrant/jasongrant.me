    ...
    return (
        <Section py="4">
            <Flex direction="column">
                ...
                <RowItem startLabel="Klaviyo" url="/klaviyo" endLabel="2021 - Now_" />
                <RowItem startLabel="Vertex" url="/vertex" endLabel="2017 - 2021" />
                <RowItem startLabel="Collaborative" url="/collaborative" endLabel="2014 - 2017" />
