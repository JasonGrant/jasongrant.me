...
import WorkCard from '@/ui/narrative/WorkCard';
        ...
        <ScrollArea type="auto" scrollbars="vertical" size="2" radius="full" style={{ height: `100%` }}>
            <Flex direction="column" gap="4" overflow="scroll" pr="6" pb="9">
                ...
                <WorkCard
                    ...
                    linkUrl='/narrative/vertex/work/loof'
                    linkType='internal'
                >
                ...
                <WorkCard
                    ...
                    linkUrl='/narrative/vertex/work/via'
                    linkType='internal'
                >
                    <Heading as="h3" size="3">
                        VIA Design System
                ...
                <WorkCard
                    ...
                    linkUrl='/narrative/vertex/work/vip'
                    linkType='internal'
                >
                    <Heading as="h3" size="3">
                ...
                <WorkCard
                    ...
                    linkUrl='/narrative/vertex/work/ci'
                    linkType='internal'
                >
                    <Heading as="h3" size="3">
