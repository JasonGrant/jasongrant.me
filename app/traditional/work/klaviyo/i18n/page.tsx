        ...
        <>
            ...
            >
                ...
                <Text 
                    size="3"
                >
                    If you are unable to view the embedded Figma file, please <Link href="https://www.figma.com/deck/r70bnELg6qQ7SUO9S239H1/Case-Study---Klaviyo-i18n-and-l10n?node-id=1-532&node-type=canvas&viewport=247%2C195%2C0.02&t=yMAoiLBfLduBzZfj-1&scaling=min-zoom&content-scaling=fixed&page-id=0%3A1" target="_blank">click this link</Link>.
                </Text>
                <iframe src="https://embed.figma.com/deck/r70bnELg6qQ7SUO9S239H1/Case-Study---Klaviyo-i18n-and-l10n?node-id=1-532&node-type=canvas&viewport=247%2C195%2C0.02&scaling=min-zoom&content-scaling=fixed&page-id=0%3A1&embed-host=share" allowFullScreen></iframe>
            </Container>
        </>
    );
};
