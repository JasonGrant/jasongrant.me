...
import styles from "./AccordionExampleDeck.module.css";

// Deck-only copy of work/app-shell/AccordionExample, enlarged for the stage
// (readable from a distance) rather than the site's narrow side column. Kept
// as a full copy — not a wrapped import — so its type scale can diverge
// freely from the site's without touching the public case study.
...
export function AccordionExampleDeck() {
