...
import { CampaignEditor } from "@/components/work/replica/CampaignEditor";
import { CampaignMessage } from "@/components/work/replica/CampaignMessage";
import { CampaignRecipients } from "@/components/work/replica/CampaignRecipients";
import { TranslateOverlay } from "@/components/work/replica/TranslateOverlay";
import { TranslationEditor } from "@/components/work/replica/TranslationEditor";
import classNames from "classnames";
import { type KeyboardEvent, type ReactNode, useState } from "react";
import { FiChevronLeft, FiChevronRight } from "react-icons/fi";
import styles from "./DeckEmailFlow.module.css";

// Copy of src/components/work/replica/EmailTranslationFlow.tsx (research
// D11), restructured onto DeckStepper's two-column grid (image/screen left,
// step title+caption right, controls under the screen column) instead of
// EmailTranslationFlow's single-column stack, so this slide matches the
// app-shell stepper slides' layout. /work's EmailTranslationFlow is
// untouched.
...
const FOOTNOTE = "Step through recipients, message, editor, translate, and a stale-content catch.";

export function DeckEmailFlow() {
