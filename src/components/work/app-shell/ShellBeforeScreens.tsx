...
const SLIDES: StepperSlide[] = [
  {
    ...
    caption:
      "The baseline shell: a full labeled left nav, the inbox list, the conversation, and a right panel split into just two tabs, Details and Manage.",
    width: 3600,
    height: 2254,
  },
  {
    ...
    caption:
      "Editing a contact's details in place. Every field the case needs (contact info, claim number, status) competes for the same single tab.",
    width: 3600,
    height: 2254,
  },
  {
    ...
    title: "Manage",
    caption:
      "Manage is the shell's other tab: participants and case visibility, with no room for anything else. Any additional capability had nowhere to go but a new tab or a deeper accordion.",
    width: 3600,
    height: 2254,
  },
  {
    ...
    title: "Media",
    caption:
      "Media, here a voicemail with an AI transcription, is squeezed into the same Details tab as everything else, one more thing stacked into a fixed space.",
    width: 3600,
    height: 2254,
  },
  {
    ...
    title: "Create Case",
    caption:
      "Starting a new case opens a modal over the whole shell. The case being created has no relationship yet to the shell it's about to join.",
    width: 3600,
    height: 2254,
  },
];
