...
interface DropdownProps {
  ...
  /** When the guided tour is playing, the control is display-only (Jason's
   *  rule: play => disabled, otherwise interactive). */
  disabled?: boolean;
}

// Nord/Graphite-style select: styled trigger + floating listbox, keyboard
