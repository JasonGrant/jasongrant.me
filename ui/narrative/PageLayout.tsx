            ...
            <div className={styles.container}>
                ...
                <aside 
                    ...
                    className={`
                        ...
                        ${paths.startsWith('/narrative/about') ? styles.about : ''}  
                        ${paths.startsWith('/narrative/klaviyo') ? styles.klaviyo : ''} 
                        ${paths.startsWith('/narrative/vertex') ? styles.vertex : ''}
                        ${paths.startsWith('/narrative/collaborative') ? styles.collaborative : ''}
                        ${paths.startsWith('/narrative/dassault') ? styles.dassault : ''}
                    `}
                >
                    {children}
                </aside>
